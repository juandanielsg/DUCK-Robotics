...
from ur10e_sim_control.Utility import get_quaternion_from_euler, euler_from_quaternion, KinematicChain, build_se3_transform
...
class UR10e():
    ...
    def __init__(self, logfile=None, sim=True, tool=None):
    ...
    def goalcallback(self,msg):
        ...
        self.setGoal(data, interp=False)
...
def main():
    ...
    robot = UR10e(logfile=logpath, sim=True, tool="cylinder1")
    cnt = 0
    ref_rate = 1000
    save_rate = 10
    time1 = time.time()
    ...
    while not rospy.is_shutdown():
        ...
        if cnt % ref_rate == 0:
            ...
            """if robot.EEHomMat is not None:
                print(robot.pose6)
                print(robot.toolpose)
                print(robot.EEHomMat)"""
            
            #print(robot.KinChain.invtool)
            #print(robot.KinChain.tool)
